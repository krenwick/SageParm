...
outname1 <- "monthg_summergrass1"
outname2 <- "monthg_summergrass2"
...
ggsave("figures/GPP_LAI_newphen_GPPopt.pdf", plot=both,
...
ggsave("figures/GPP_LAI_newmods_GPPopt.pdf", plot=both,
...
ggsave("figures/GPP_LAI_newmods_printsafe_GPPopt.pdf", plot=both,
       width = col2, height = 120, units = 'mm')
...
ggsave("figures/GPP_LAI_newmods_xy_GPPopt.pdf", plot=bothxy,
       width = col2, height = 120, units = 'mm')
