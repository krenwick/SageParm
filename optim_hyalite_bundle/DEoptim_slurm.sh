...
#SBATCH -J DEoptim1_summergreen1
...
for fil in $scriptsDir/Slurm_scripts/Optimization/summergreen_optim1_LM.ins $scriptsDir/Slurm_scripts/Optimization/lai_gpp.csv $scriptsDir/Slurm_scripts/Optimization/RCflux_15_16.csv $scriptsDir/Slurm_scripts/Optimization/DE_optim.R $scriptsDir/Slurm_scripts/Optimization/runjob.sh; do
...
mv $jobdir/DE1.RData $jobdir/Output_$jobname
